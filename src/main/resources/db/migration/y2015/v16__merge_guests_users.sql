...
alter table dw1_users add constraint dw1_users_email__c check (email ~~ '%@%.%' or user_id < 0);

drop index dw1_users_site_email__u;
create unique index dw1_users_site_email__u on dw1_users(site_id, email) where user_id >= 0;
